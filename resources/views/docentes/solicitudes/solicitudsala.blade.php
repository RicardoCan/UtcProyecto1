...
<form action="{{url('solicitudsala')}}" method="POST" name="solicitudsform">
	{{csrf_field()}}
	<div class="row">
    	...
    	<div class="col-md-12">
    		<div class="form-group">
            	<button class="btn btn-primary float-right" type="submit" name="submit" value="Enviar" disabled="">Enviar</button>
...
@push('scripts')
<script src="js/solicitudes/permitir.js"></script>
@endpush